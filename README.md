...
School identification & location

Enrollment and beneficiary details

Feeding programme type and coverage

Food supply, storage, and distribution
...
✅ Structured skip logic to reduce respondent burden
✅ Validation constraints to improve data accuracy
✅ Metadata capture (date, enumerator, location)
...
Logical relevance conditions

Numeric range constraints

Consistent identifiers for schools
...
Identifying supply chain and coordination gaps
...
SurveyCTO deployment readiness

Field data collection logic
